export const socialLinks = [
  ...
  {
    icon: { svg: '<img style="width: 20px; border-radius: 20%;" src="/fish.png">' },
    link: 'https://zhouyu2156.gitee.io/rabbitwarehouse/Programming/'
  },
  {
    icon: { svg: '<img style="width: 20px; border-radius: 20%;" src="/bilibili.svg">' },
